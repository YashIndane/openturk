...
def gen_move(fen: str, strength: int) -> dict:
            ...
            Otherwise a dict:
                {
                    ...
                    "capture": bool,  # True if this move captures an opponent piece
    ...
    # is_capture() must be checked BEFORE the move is pushed — it looks at
    # whether the destination square is currently occupied by an opponent
    # piece (or matches an en passant capture), which only makes sense
    # against the pre-move board state.
