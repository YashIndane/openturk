...
# ---- Config ----
image_path = "sample_boards/Board32.jpg"
...
If you are still unable to distinguish between a King and a Knight after analyzing their geometry, you must compare their overall height to the other pieces on the board.

The King: Look for the absolute tallest piece(s) on the board. The King towers over the Pawns, Knights, and Rooks. If the piece is massive and the tallest in its vicinity, it is a KING.

The Knight: The Knight is a mid-sized piece. It is noticeably shorter than the King and Queen. If the piece in question is clearly shorter than the tallest pieces on the board, it is a KNIGHT.
